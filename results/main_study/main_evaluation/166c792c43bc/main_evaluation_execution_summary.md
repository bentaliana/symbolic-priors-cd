# Main-evaluation execution summary
...
- summary_dir: results/main_study/main_evaluation/166c792c43bc
- per_workload_record_paths: see main_evaluation_workload_status.csv for record_path and configuration_hash_full per run